...
<td height=30 style="padding-top:3;"><?=$face_image?><?=$name?></td>
</tr>
...
<td height=30 class=ver7><?=$homepage?></td>
</tr>
<tr><td height=1 colspan=2 class=line></td></tr>
<?=$hide_homepage_end?>
...
<td height=30 style="padding-top:3;"><?=$subject?></td>
</tr>
...
<td height=30 class=ver7><?=$a_file_link2?><?=$file_name2?> (<?=$file_size2?>)</a></td>
</tr>
<?=$hide_download2_end?>
...
<td height=30 class=ver7><?=$sitelink1?></td>
</tr>
<?=$hide_sitelink1_end?>
...
<td height=30 class=ver7><?=$sitelink2?></td>
</tr>
<?=$hide_sitelink2_end?>
