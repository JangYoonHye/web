...
<td width=<?echo (100 / $max_show_image);?>% valign=top align=center style='padding:15 5 0 5;'>
   ...
   <td>
       ...
       <tr>
       <td align=center style='padding:5;' class=line><a href=<?=$data[sitelink1]?> target=_blank onfocus=this.blur()><img src=<?=$data[sitelink2]?> width=<?=$img_w?>  height=<?=$img_h?> border=0></a><br><font style=font-family:tahoma;font-size:6pt;><b><?=$data[subject]?></b><?=$hide_cart_start?><br><input type=checkbox name=cart value="<?=$data[no]?>"><?=$hide_cart_end?><b><?=$a_modify?>MOD</a>&nbsp;<b><?=$a_delete?>DEL</a>&nbsp;</td>
       </tr>
       </table>
   </td>
   </tr>
