...
<td width=<?echo (100 / $max_show_image);?>% valign=top align=center style='padding:15 5 0 5;'>
   ...
   <td>
       ...
       <tr>
       <td align=center style='padding:0;' class=input><a href=view.php?id=<?=$id?>&no=<?=$data[no]?> onfocus=this.blur()><img src=<?=$img_name?> width=<?=$img_w?>  height=<?=$img_h?> border=0></a></td>
       </tr>
       <tr>
